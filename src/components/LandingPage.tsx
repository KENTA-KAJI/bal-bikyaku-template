    ...
    <>
      ...
      <Section>
        ...
        <div className={styles.prose}>
          ...
          <p>
            <strong>
              問題は、その介入が「評価に基づいて選んだもの」なのか、「経験的に選んだ一つの仮説」なのかということです。
            </strong>
          </p>
          <p>
      ...
      <Section dark>
        ...
        <div className={styles.prose}>
          ...
          <p>
            <strong className={styles.emphasisInline}>
              そのうえで、第4回では、これらをつなげます。
            </strong>
            複数の部位に同時に問題が見られるクライアントに対して、動作評価から問題を整理し、どこから介入するべきかという優先順位を判断する力を養います。
          </p>
          <p>
      ...
      <Section dark>
        ...
        <div className={styles.prose}>
          ...
          <p className={styles.emphasisText}>
            こうした実践は、定員10名という少人数だからこそ可能になります。
          </p>
          <p className={styles.emphasisText}>
      ...
      <Section>
        ...
        <dl className={styles.overview}>
          {[
            ...
            [
              "開催日",
              "第1回：2026年9月23日（水）／第2回：10月末予定／第3回：11月末予定／第4回：12月末予定",
            ],
            ["開催時間", "全回 12:00–17:00"],
            ["講師", "渡辺慶輔"],
          ].map((x) => (
